...
export function MorphPanel() {
  ...
  return (
    <div
      className="flex items-center justify-center w-full max-w-[280px] sm:max-w-[320px]"
      style={{ height: showForm ? FORM_HEIGHT : 44 }}
    >
      <motion.div
        ref={wrapperRef}
        data-panel
        className={cx("bg-background relative z-3 flex flex-col items-center overflow-hidden border")}
        initial={false}
        animate={{
        ...
        {showForm && (
          ...
          >
            <div className="flex justify-between py-1">
              <p className="text-foreground z-2 ml-[38px] flex items-center gap-[6px] select-none">AI Input</p>
              <button
                type="submit"
                ref={btnRef}
